...
class Template(models.Model):
    ...
    x_coord = models.FloatField(default=200, help_text="Posición X del nombre")
    y_coord = models.FloatField(default=300, help_text="Posición Y del nombre")
    font_size = models.IntegerField(default=24, help_text="Tamaño de fuente")
    font_color = models.CharField(max_length=20, default="#000000", help_text="Color del texto")
    font_family = models.CharField(max_length=50, default="Helvetica-Bold", help_text="Fuente")
